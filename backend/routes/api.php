...
Route::put('/auth/new-password/{code}/{id}', [UserController::class, 'new_password']);
Route::get('/auth/verify/{code}/{id}', [UserController::class, 'verify']);
Route::put('/auth/activate/{code}/{id}', [UserController::class, 'activate']);

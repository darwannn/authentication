        ...
        <div class="container">
            <div class="flex flex-wrap -mx-4">
               ...
               ">
                        ...
                        " v-model="form.identifier" id="identifier" name="identifier"
                                    placeholder="Username or Email" /> <small
                                    class="text-left text-red-500">{{ error.identifier }}</small>
                            </div>
                            <div class="mb-6">
                        ...
                        <div class="text-center">
                            ...
                            <a href="/forgot-password" class=" text-base inline-block mb-2 text-[#adadad] hover:underline hover:text-primary
                  ">
                                Forgot Password?
                            </a>
